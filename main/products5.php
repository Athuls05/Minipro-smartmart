...
<html lang="en">
<head>
<title>SSmart mart an E-commerce Online Shopping Category Flat Bootstrap Responsive Website Template | Products5 :: w3layouts</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="SSmart mart Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
		...
		<div class="header-two"><!-- header-two -->
			<div class="container">
				...
				<div class="header-cart"> 
					...
					<div class="cart"> 
						<form action="cart1.php" method="post" class="last"> 
							<!-- <input type="hidden" name="cmd" value="_cart" />
							<input type="hidden" name="display" value="1" /> -->
							<?php
								$select_rows = mysqli_query($conn, "SELECT * FROM `cart`") or die('query failed');
								$rc = mysqli_num_rows($select_rows);
							
							?>
							<button class="w3view-cart" type="submit" name="submit" value=""><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>
							<span class="badge position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger"><?php echo $rc;?></span>
							</button>
						</form>  
					</div>
					<div class="clearfix"> </div> 
			...
			<div class="col-md-9 product-w3ls-right">
				...
				<?php
					...
					if(mysqli_num_rows($select_products) > 0){
						while($fe = mysqli_fetch_array($select_products)){
				?>
				<div class="products-row">
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							<div class="new-tag"><h6>1%<br>Off</h6></div>
							<a href="products5.php"><img src="../admin/html/uploaded_img/<?php echo $fe['image']; ?>" class="img-responsive" alt="img"></a>
							<div class="agile-product-text">              
								<h5><a href="single.html"><?php echo $fe['name']; ?></a></h5> 
								<h6><?php echo $fe['price']; ?></h6> 
								<form action="" method="post">
									<div class="box">
										<!-- <img src="../admin/html/uploaded_img/<?php echo $fe['image']; ?>" alt=""> -->
										<h3><?php echo $fe['name']; ?></h3>
										<div class="price">$<?php echo $fe['price']; ?>/-</div>
										<input type="hidden" name="product_name" value="<?php echo $fe['name']; ?>">
										<input type="hidden" name="product_price" value="<?php echo $fe['price']; ?>">
										<input type="hidden" name="product_image" value="<?php echo $fe['image']; ?>">
			...
			<div class="col-md-3 rsidebar">
				...
				<div class="related-row">
					...
					<div class="galry-like">  
						...
						<h4><a href="products5.html">Audio speaker</a></h4> 
						<h5>$100</h5>       
					</div>
				</div>
			</div>
