...
<html lang="en">
<head>
<title>Smart mart an E-commerce Online Shopping Category Flat Bootstrap Responsive Website Template | Home :: w3layouts</title>
		...
		<div class="header-two"><!-- header-two -->
			<div class="container">
				<div class="header-logo">
					<h1><a href="index.html"><span>S</span>martmart</a></h1>
				...
				<!-- <div style="display:flex;">
					<div>
						<a href="contact.html"><i class="fa fa-map-marker" aria-hidden="true">CONTACT_US</i> </a>
					</div>&nbsp;&nbsp;
					<div>
						<a href="../logout.php"><i class="fa fa" aria-hidden="true">LOG_OUT</i></a>
					</div>
				...
				<div class="header-cart">
					...
					<!--<div class="my-account">
						<button><a href="../logout.php"><i  aria-hidden="true"></i> LOG_OUT</a></button>						
					</div>-->
				...
				<!-- <div class="header-cart">  -->
					<!-- <div class="my-account">
						<a href="contact.html"><i class="fa fa-map-marker" aria-hidden="true"></i> CONTACT US</a>
						<a href="../logout.php"><aria-hidden="true"></i> LOG_OUT</a>						
					</div> -->
					<!-- <div>
						<a href="../logout.php"><aria-hidden="true"></i> LOG_OUT</a>						
					</div> -->
