...
<section class="shopping-cart">
   ...
   <table>
      ...
      <tbody>
         ...
         <tr>
            <td><img src="../admin/html/uploaded_img/<?php echo $fetch_cart['image']; ?>" height="100" alt=""></td>
         ...
         <tr class="table-bottom">
            <td><a href="products5.php" class="option-btn" style="margin-top: 0;">continue shopping</a></td>
