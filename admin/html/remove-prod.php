...
<body>
    ...
    <h1 class="text-center">Remove Product <i class="fas fa-cogs"></i></h1>
  </div>
        ...
        $result=mysqli_query($link,$qry);
          ...
          echo"<table class='table table-bordered table-hover'>
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'><a href='delete-prod.php?id=".$row['id']."' style='color:#F66;'><i class='fas fa-trash'></i> Remove</a></div></td>
