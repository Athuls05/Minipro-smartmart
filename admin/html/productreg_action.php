...
$sql=mysqli_query($con,"INSERT INTO `tbl_product`(`product_name`, `c_id`, `type_id`, `product_rate`, `image`, `product_description`) VALUES ('$product','$c_id','$type_id','$rate','$s','$description')");
